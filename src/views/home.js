    ...
    <>
      <div className="home-container">
        ...
        <section className="home-features">
          <FeatureCard
            text="Upcoming missions, space news, & developments in space exploration. "
            title="News & Updates"
            image_src="/cube1.svg"
          ></FeatureCard>
          <FeatureCard text="View stunning images & videos captured during space missions, training, & personal experiences. "
            title="Photo Gallery" image_src="/camera.svg"></FeatureCard>
          <FeatureCard
            text="Providing informative articles, videos, & resources to educate readers about space, astronomy, & related topics."
            title="Education"
            image_src="/grad-cap.svg"
          ></FeatureCard>
          <FeatureCard
            text="Share mission details, timelines, & personal reflections before, during, & after space travel."
            title="Mission Diary"
        ...
        <section className="home-contaier">
          <div className="home-container30">
            ...
            <h2 className="home-text30 HeadingTwo">
              <span className="home-text31">Taking a Trip to Space</span>
            </h2>
          ...
          <div className="home-container32">
            ...
            <div className="home-container36">
              <ListItem title="1. Physical Fitness"
                description="They undergo rigorous training & are exposed to the physical stresses of launch, microgravity, & spacewalks. Maintaining good cardiovascular health, strength, & overall fitness is essential."></ListItem>
              <ListItem
                title="2. Mental Resilience"
                description="Astronauts must demonstrate resilience, adaptability, & the ability to manage stress effectively."
              ></ListItem>
              <ListItem
                title="3. Problem-Solvers"
                description="Astronauts often encounter unexpected challenges & emergencies in space. They must be skilled problem solvers, capable of making quick, critical decisions under pressure."
              ></ListItem>
            </div>
          </div>
          ...
          <div className="home-container37">
            <div className="home-container38">
              <ListItem
                title="4. Technical Proficiency"
                description="Astronauts have to operate complex spacecraft systems, conduct scientific experiments, & perform repairs during spacewalks. A strong background in technical fields like engineering, mathematics, or science is typically required."
              ></ListItem>
              <ListItem
                title="5. Educated & Trained"
                description="Most astronauts have at least a bachelor's degree in a relevant field, & many have advanced degrees. They undergo extensive training in spacecraft operation, spacewalking, survival skills, & more."
              ></ListItem>
              <ListItem
                title="6. Detail-Oriented"
                description="In the harsh environment of space, even small errors can have significant consequences. Astronauts must be meticulous & detail-oriented in their work to ensure safety & mission success."
              ></ListItem>
            </div>
